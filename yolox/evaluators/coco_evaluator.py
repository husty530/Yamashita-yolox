...
class COCOEvaluator:
    ...
    def evaluate(
        ...
        eval_results = self.evaluate_prediction(data_list, statistics, classes)
        synchronize()
        return eval_results
    ...
    def evaluate_prediction(self, data_dict, statistics, classes):
        ...
        if len(data_dict) > 0:
            ...
            if self.per_class_mAP:
                info += "per class mAP:\n" + per_class_mAP_table(cocoEval, classes) + "\n"
            if self.per_class_AR:
                info += "per class AR:\n" + per_class_AR_table(cocoEval, classes) + "\n"
